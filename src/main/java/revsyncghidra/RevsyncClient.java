...
public class RevsyncClient {
   ...
   public class RevSub extends JedisPubSub {
      ...
      public RevSyncGhidraPlugin frontend;
...
// public RevSub revsub = new RevSub(frontend);
   ...
   public RevsyncClient(RevSyncGhidraPlugin frontend, RevsyncConfig conf) { //String host, int port, String nick, String password) {
